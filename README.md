...
- **Admin girişi**: `ilan-giris.html` artık herkese açık değil. Kullanıcı adı `admin`, şifre `doRw!6bz9r-Yj9WC` ile giriş yapılmadan form görüntülenemez.
...
- [ ] Admin şifresi (`admin` / `doRw!6bz9r-Yj9WC`) gerçek yayında değiştirilebilir ve/veya `ilan-giris.html`'i tamamen gizli bir URL'de tutmayı düşünün — client-side kilit tek başına yeterli güvenlik değildir
